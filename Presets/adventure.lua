    ...
    newLocationsFirstCastle = {
        {
            ...
            name = "Balroom Mask",
            status = false,
            mapTiles = {{address = 0x06BE9A, values = {4, 20}}},
            mapX = 210,
            mapY = 364,
            locks = {{"JEWEL_OF_OPEN", "SOUL_OF_BAT"}, {"JEWEL_OF_OPEN", "LEAP_STONE"},  {"JEWEL_OF_OPEN", "GRAVITY_BOOTS", "SOUL_OF_WOLF"},
            {"JEWEL_OF_OPEN", "GRAVITY_BOOTS", "FORM_OF_MIST"}, {"JEWEL_OF_OPEN", "FORM_OF_MIST", "POWER_OF_MIST"}, {"JEWEL_OF_OPEN", "SOUL_OF_WOLF", "POWER_OF_WOLF"}},
            ...
            name = "Nunchaku",
            status = false,
            mapTiles = {{address = 0x06BDCD, values = {21, 85}}},
            mapX = 306,
            mapY = 268,
            ...
            name = "Shaman Shield",
            status = false,
            mapTiles = {{address = 0x06BC61, values = {1, 84, 85, 4}}, {address = 0x06BC51, values = {21, 1, 4, 5}},
             {address = 0x06BC52, values = {64}}},
            mapX = 446,
            mapY = 76,
            ...
            name = "Jewel Knuckles",
            status = false,
            mapTiles = {{address = 0x06BD32, values = {1}}},
            mapX = 474,
            mapY = 180,
            locks = {},
            reachable = true
            ...
            name = "Bronze Cuirass",
            status = false,
            mapTiles = {{address = 0x06BCD0, values = {21}}},
            mapX = 394,
            mapY = 132,
            locks = {},
            reachable = true
    ...
    newLocationsSecondCastle = {
        {
            ...
            status = false,
            mapTiles = {{address = 0x06C1BB, values = {64}}},
            mapX = 224,
            mapY = 218,
            locks = {},
            reachable = true
            ...
            status = false,
            mapTiles = {{address = 0x06C16A, values = {68, 84, 85}}},
            mapX = 208,
            mapY = 178,
            locks = {},
            reachable = true
            ...
            name = "Alucard Mail",
            status = false,
            mapTiles = {{address = 0x06C24B, values = {5, 85}}},
            mapX = 240,
            mapY = 290,
            locks = {},
            reachable = true
            ...
            name = "Talisman",
            status = false,
            mapTiles = {{address = 0x06C11E, values = {1}}},
            mapX = 344,
            mapY = 138,
            locks = {},
            reachable = true
